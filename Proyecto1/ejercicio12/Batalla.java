...
public class Batalla{
	...
	/**	for(int i = 0; i < pokemIniciales.size(); i++){
			System.out.println("Nombre: " + pokemIniciales.get(i).getNombre() + " Vida: " + pokemIniciales.get(i).getVida() + " Tipo: " 
				+ pokemIniciales.get(i).getTipos() + " Nivel: " + pokemIniciales.get(i).getNivel() + " A Fisico: " + pokemIniciales.get(i).getAtaqueFisico() + 
				" A Especial: " + pokemIniciales.get(i).getAtaqueEspecial() + " D Fisica: " + pokemIniciales.get(i).getDefensaFisica() + " D Especial: " 
				+ pokemIniciales.get(i).getDefensaEspecial() + " Velocidad: " + pokemIniciales.get(i).getVelocidad());
		}*/
		}
	...
	public void mostrarElegir(){
		...
		/**System.out.println("\tLos pokemones que puedes elegir son: ");
		for(int i = 0; i < pokemIniciales.size(); i++){
			System.out.println("Nombre: " + pokemElegir.get(i).getNombre() + " Vida: " + pokemElegir.get(i).getVida() + " Tipo: " 
				+ pokemElegir.get(i).getTipos() + " Nivel: " + pokemElegir.get(i).getNivel() + " A Fisico: " + pokemElegir.get(i).getAtaqueFisico() + 
				" A Especial: " + pokemElegir.get(i).getAtaqueEspecial() + " D Fisica: " + pokemElegir.get(i).getDefensaFisica() + " D Especial: " 
				+ pokemElegir.get(i).getDefensaEspecial() + " Velocidad: " + pokemElegir.get(i).getVelocidad());
		}*/		
	}
